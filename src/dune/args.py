...
class arg_parser:
   def __init__(self):
      ...
      self._parser.add_argument('--set-core-contract', metavar=["ACCOUNT"], help='set the core contract to an account given (default normally is `eosio`)')
      ...
      self._parser.add_argument('--set-token-contract', metavar=["ACCOUNT"], help='set the token contract to an account given (default normally is`eosio.token`)')
      ...
      self._parser.add_argument('--bootstrap-system-full', action='store_true', help='same as `--bootstrap-system` but also creates accounts needed for core contract and deploys core, token, and multisig contracts')
      ...
      self._parser.add_argument('--debug', action='store_true', help='print additional info useful for debugging, like running docker commands')
